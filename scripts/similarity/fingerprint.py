...
PART_FAMILY_PREFIX_CATEGORIES: tuple[tuple[str, str], ...] = (
    ...
    ("stepped pin", "pin"),
    ("spring pin", "pin"),
    ("workpiece clamp", "clamp"),
    ("straight line action clamp", "clamp"),
    ("adjusting screw", "screw"),
    ("mechanical switch", "switch"),
    ("filter", "filter"),
    ("regulator", "regulator"),
    ("lubricator", "lubricator"),
    ("leveling mount", "mount"),
    ("naams component", "naams"),
    ("wheel conveyor", "conveyor"),
    ("conveyor", "conveyor"),
    ("manifold", "manifold"),
    ("stopper", "stopper"),
    ("robot", "robot"),
    ("linear guide accessory", "guide_rail"),
    ("linear guide", "guide_rail"),
    ("guide rail", "guide_rail"),
)
